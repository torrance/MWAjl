// g++ -O3 -shared -fPIC -I ~/Downloads/mwa-reduce/beam -I/usr/include/hdf5/serial src/beam.cpp ~/Downloads/mwa-reduce/beam/beam2016implementation.cpp -lhdf5_cpp -lboost_filesystem -o src/libbeam.so
